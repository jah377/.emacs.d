...
Other resources that I found helpful include: frequently visit include:
...
+ initial-scratch-message :: ~nil~ for empty =*scratch*= buffer
  - Startup stats added to =*scratch*= in [[id:1269b427-94e9-4df5-98bf-c83a31db096d][Profile Emacs Startup]] section
...
Previously in [[id:19407840-a20f-4225-9484-bbf88d3ff00d][Temporarily Configure Garbage Collection]] , =gc-cons-threshold= and
=gc-cons-percentage= were set to a large amount in order to prevent GC during
initialization. _Must_ reduce to avoid Emacs freezing.

*TODO:* Select appropriate values based on computer specs.
