...
However, setting ~org-startup-indented t~ (see [[id:1ef23429-c87a-4921-8dfc-f3169a907451][General Settings]] section) disables
the fringe area of the block and "bracket" provided by =org-modern=. The small
package =org-modern-indent= fixes this issue. The package also indents blocks
nested within lists; by default, blocks inserted within lists align to the
=org-heading=, not the bullet point.
